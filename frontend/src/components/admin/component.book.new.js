...
function BookNew(){
    ...
    async function handleForm(event){
        ...
        const book={"name":name,"description":description,"isbn":isbn,"author":author,"editor":editor,"publication_date":publication_date,"price":price}
        addBook(book)
    ...
    return(
        <div className={"container mt-5"}>
            ...
            <label className={"form-label"} htmlFor={"publication_date"}>Publication Date </label>
            <input className={"form-control"} onChange={e => setPublication_date(e.target.value)} type="date" id={"publication_date"}/>
